...
/* var searchbox = document.getElementById("search_location").value;  */
  var events = [
      ...
      ['<p><b>Sommersby Party </b></p>' + '<p> Address: K Urban Beach</p>' +  '<p> Dance, drink and have fun in a sponcered by Sommersby Party in one of the biggest clubs in Lisbon. Club fee required. Check the fb page for prices </p>' + '<p>When: 31 July </p>' + '<p>Duration: 23:00 to 6:30</p> ' + '<p> <a href = "https://www.facebook.com/events/1746177388830384/"> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.704230, -9.155473, 4],
      ['<p><b>Traditional Fado </b></p>' + '<p> Address: pavilhao chines</p>' +  '<p> Enjoy some traditional Portuguese music in a unique 20s themed bar. Free entry</p>' + '<p>When: 31 July </p>' + '<p>Duration: 19:00 </p> ' + '<p> <a href = "https://www.facebook.com/events/268567450358684/"> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.715784, -9.146719, 4],
      ['<p><b>Erasmus Tuesday Party </b></p>' + '<p> Address: Musicbox Pink Street </p>' +  '<p> One of Lisbons best parties for all its foreign Erasmus students </p>' + '<p>When: 31 July </p>' + '<p>Duration: 23:55 to 6:30</p> ' + '<p> <a href = "https://www.facebook.com/events/118140258854700/"> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.707249,-9.143795, 4],
      ['<p><b>Taste of Portugal:  Pasteis de Nata </b></p>' + '<p> Address: Time Out Market</p>' +  '<p> For 2 hours learn how to bake Portguese delicacies and try a variation of them. Price 25 Euros </p>' + '<p>When: 31 July </p>' + '<p>Duration: 17:00 to 19:00</p> ' + '<p> <a href = "https://www.timeout.pt/lisboa/pt/coisas-para-fazer/taste-of-portugal-pasteis-de-nata "> Visit for more information</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.706735,-9.145945, 4],
      ['<p><b>Zarco concert and surprise DJ set </b></p>' + '<p> Address: Anjos 70 </p>' +  '<p> Discover an underground artist and enjoy a DJ set in the most vitage market in Lisbon</p>' + '<p>When: 31 July </p>' + '<p>Duration: 18:00 to 00:00</p> ' + '<p> <a href = "https://www.facebook.com/events/204824243553841/ "> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.725745,-9.135067, 4],
      ['<p><b>Ladies Night </b></p>' + '<p> Address: Docks Club</p>' +  '<p> Club night out check the FB page for details </p>' + '<p>When: 31 July </p>' + '<p>Duration: 23:55 to 6:30</p> ' + '<p> <a href = "https://www.facebook.com/DocksClubLadiesNight/ "> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.703111,-9.167267, 4],
      ['<p><b>Bored But Secured </b></p>' + '<p> Address: Ruas das Janelas Verders, 1288</p>' +  '<p> Discover new artists in an out of this world exhibition in Lisbon</p>' + '<p>When: 1 - 7 August </p>' + '<p>Duration: 15:00 - 20:00</p> ' + '<p> <a href = "https://www.facebook.com/events/2131027723832716/ "> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.705455,-9.160235, 4],
      ['<p><b>Jazz in August </b></p>' + '<p> Address: Fundação Calouste Gulbenkian </p>' +  '<p>Enjoy the summer breeze in one of Lisbons most beautiful gardens while listening to jazz bands. Times and fees change according to the day</p>' + '<p>When: 31 July - 5 August </p>' + '<p>Duration: Varies </p> ' + '<p> <a href = "https://www.visitportugal.com/en/node/155783 "> Check out for more details</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.736836, -9.153852, 4],
      ['<p><b>Soul Cave + The Djabalis </b></p>' + '<p> Address: Tokyo Club, Lisboa</p>' +  '<p> Live music in a small and cozy club in Lisbons famous Pink Street</p>' + '<p>When: 2 August</p>' + '<p>Duration: 23:00 to 6:30</p> ' + '<p> <a href = "https://www.facebook.com/events/2163750463900996/ "> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.707193, -9.143191, 4],
      ['<p><b>Sunset on Bar da Praia </b></p>' + '<p> Address: Travessa Frederico Arouca, Cascais</p>' +  '<p> One of the best places to grab a beer to watch the Sunset in Cascais</p>' + '<p>When: Every Thursday </p>' + '<p>Duration: 17:00 to 20:00</p> ' + '<p> <a href = "https://www.facebook.com/events/207719239944465/ "> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.699953, -9.418315, 4],
      ['<p><b>Yoga Class </b></p>' + '<p> Address: Kwenda Lima - Art Kaizen</p>' +  '<p> Become one with yourself with some great Yoga and Meditation</p>' + '<p>When: 2 August - 30 August </p>' + '<p>Duration: 20:00 - 21:30</p> ' + '<p> <a href = "https://www.facebook.com/events/1746177388830384/"> FB Event</a></p>' + '<p><button type="button">I am interested in this event</button></p>', 38.704230, -9.155473, 4],
      ];
